...
const CartItem = ({ onContinueShopping, showComingSoon, setShowComingSoon, setAddedToCart }) => {
  ...
  return (
    showComingSoon ? (
      <div className="coming-soon-container" style={{ textAlign: 'center', padding: '50px' }}>
        <h1>Coming Soon</h1>
        <p>Stay tuned for updates on our checkout system!</p>
      </div>
    ) :
